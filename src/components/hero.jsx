...
const HeroCarousel = () => {
  ...
  return (
    <section
      className="swiper h-[90vh] min-h-[600px] max-h-[900px] relative mt-15 "
    ...
    >
      <div className="swiper-wrapper">
        ...
        <article className="swiper-slide relative">
          <img
            src={centerCarouselImg}
            alt="The Sarabi restaurant interior"
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
            <div className="max-w-4xl mx-auto">
              <div className="mb-8 [text-shadow:_0_4px_4px_rgba(0,0,0,0.7)]">
                <h1 className="text-5xl md:text-7xl lg:text-6xl font-light text-white">
                  The Sarabi Restaurant
                </h1>
                <h2 className="text-4xl md:text-6xl lg:text-5xl font-light text-white mt-4 italic">
                  Freshness | Culture | Community
                </h2>
              </div>
              {/* Button adjustments: Always flex-row */}
              <div className="flex flex-row gap-4 justify-center">
                {" "}
                {/* Changed flex-col to flex-row for mobile */}
                <a
                  href="order-now.html"
                  className="bg-[#EB9D69] text-white hover:bg-[#e08d55] font-medium 
                                                   py-3 px-8 rounded-full text-lg 
                                                   transition duration-300"
                >
                  {" "}
                  {/* Removed w-fit as they will grow to content */}
                  Order Now
                </a>
                <a
        ...
        <article className="swiper-slide relative">
          <img
            src={rightCarouselImg}
            alt="Delicious food at The Sarabi"
            className="absolute inset-0 w-full h-full object-cover"
          />
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
            <div className="max-w-4xl mx-auto">
      ...
      <button
        className="swiper-button-next !text-white !right-8"
        aria-label="Next slide"
      ></button>
      <button
        className="swiper-button-prev !text-white !left-8"
