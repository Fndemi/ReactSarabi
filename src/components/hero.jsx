          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-row gap-4 justify-center"> {/* Changed flex-col to flex-row for mobile */}
                <a href="order-now.html" className="bg-[#EB9D69] text-white hover:bg-[#e08d55] font-medium 
                                                   py-3 px-8 rounded-full text-lg 
                                                   transition duration-300"> {/* Removed w-fit as they will grow to content */}
                  Order Now
                </a>
                <a href="reservations.html" className="bg-[#EB9D69] text-white hover:bg-[#e08d55] font-medium 
                                                      py-3 px-8 rounded-full text-lg 
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-row gap-4 justify-center">
                <a href="menu.html" className="bg-[#EB9D69] text-white hover:bg-[#e08d55] font-medium 
                                                   py-3 px-8 rounded-full text-lg 
        ...
        <article className="swiper-slide relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Button adjustments: Always flex-row */}
              <div className="flex flex-row gap-4 justify-center">
                <a href="gallery.html" className="bg-[#EB9D69] text-white hover:bg-[#e08d55] font-medium 
                                                   py-3 px-8 rounded-full text-lg 
                                                   transition duration-300">
                  Order Now
                </a>
                <a href="contact-us.html" className="bg-[#EB9D69] text-white hover:bg-[#e08d55] font-medium 
                                                      py-3 px-8 rounded-full text-lg 
                                                      transition duration-300">
                  Reserve Seat
                </a>
