    ...
    <div className="bg-rose-brown min-h-screen dark:bg-[#2c2222] transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 pt-20 bg-primary-content-bg dark:bg-[#4a3a4a] transition-colors duration-300">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-800 dark:text-[#f0d6d6]">Contact Us</h1>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-8 h-8 rounded-full flex items-center justify-center">
               <img src={visitIcon} alt="Visit Us Icon" className="w-full h-full object-contain" />
              </div>
                            <h2 className="text-2xl font-bold text-gray-800 dark:text-[#f0d6d6]">Visit Us</h2>
            </div>
              ...
              <svg className="w-full h-full" viewBox="0 0 400 300" fill="none">
                ...
                <defs>
                  <pattern id="streets" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                    <rect width="40" height="40" fill="#f0f0f0" className="dark:fill-[#4a3a4a]" />
                    <path d="M0 20h40M20 0v40" stroke="#ddd" strokeWidth="1" className="dark:stroke-[#5a4545]" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#streets)" />

                {/* Route path */}
                <path d="M80 250 Q120 200 160 150 Q200 100 250 80 Q300 60 340 50" stroke="#dc2626" strokeWidth="4" fill="none" />
          ...
          <div className="bg-primary-form-bg rounded-lg p-6 md:p-8 dark:bg-[#5a4545] transition-colors duration-300">
            ...
            <form id="contactForm" className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-primary-form-label font-medium mb-2 dark:text-[#d9b8b8]">
                    Name*
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${
                      errors.name ? 'border-red-500' : 'border-gray-300 dark:border-[#7a6565]'
                  ...
                  />
                  {errors.name && (
                    <div className="error-message text-red-600 text-sm mt-1">{errors.name}</div>
                  )}
                </div>
                <div>
                  <label htmlFor="email" className="block text-primary-form-label font-medium mb-2 dark:text-[#d9b8b8]">
                    Email*
                  </label>
                  <input
                    type="email"
                    ...
                    className={`w-full px-4 py-3 rounded-lg border ${
                      errors.email ? 'border-red-500' : 'border-gray-300 dark:border-[#7a6565]'
                    } focus:border-primary-accent-orange dark:focus:border-primary-accent-orange focus:outline-none focus:ring-2 focus:ring-primary-accent-orange dark:focus:ring-primary-accent-orange focus:ring-opacity-20 bg-white dark:bg-white dark:text-gray-800`}
                  ...
                  />
                  {errors.email && (
                    <div className="error-message text-red-600 text-sm mt-1">{errors.email}</div>
                  )}
                </div>
              </div>
              ...
              {/* Subject */}
              <div>
                <label htmlFor="subject" className="block text-primary-form-label font-medium mb-2 dark:text-[#d9b8b8]">
                  Subject*
                </label>
                <div className="relative">
                  <select
                    ...
                    name="subject"
                    className={`w-full px-4 py-3 rounded-lg border ${
                      errors.subject ? 'border-red-500' : 'border-gray-300 dark:border-[#7a6565]'
                ...
                {errors.subject && (
                  <div className="error-message text-red-600 text-sm mt-1">{errors.subject}</div>
                )}
              </div>

              {/* Message */}
              <div>
                <label htmlFor="message" className="block text-primary-form-label font-medium mb-2 dark:text-[#d9b8b8]">
                  Message*
                </label>
                <textarea
                  id="message"
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${
                    errors.message ? 'border-red-500' : 'border-gray-300 dark:border-[#7a6565]'
                ...
                ></textarea>
                {errors.message && (
                  <div className="error-message text-red-600 text-sm mt-1">{errors.message}</div>
                )}
              </div>
            ...
            {/* Success Message */}
            {showSuccessMessage && (
              <div id="successMessage" className="mt-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg dark:bg-green-700 dark:border-green-800 dark:text-green-100">
